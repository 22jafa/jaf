                    ...
                    if(isset($_POST['submit'])){
                       ...
                       $acou_id=$_POST['pariv'];
                        ...
                        if (empty($email)) {
                            ...
                            $sql="INSERT INTO user(name,email,password,con_pass,acou_id) VALUES (?,?,?,?,?) " ;
                            $stm = $con->prepare($sql);
                            $stm->execute(array($name , $email ,$password ,$con_pass,$acou_id ));
                            if ($stm->rowCount()==1) {
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a href="editcategory.php?action=edit&user_id= <?php  echo $user_id ?>"
