        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="panel panel-primary">
                    ...
                    $confi_pass=md5($_POST['confi_pass']);
                    $pariv=$_POST['pariv'];
                    $select="select * from users where eamil= '$email'";
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $del  ?></td>
                                        <td><?php 
                                            $sql="select * from accounta where id=:id" ;
                                            $stm = $con->prepare($sql);
